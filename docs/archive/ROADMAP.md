...
| **`Mcp-Session-Id` Header Handling** | ✅ | Extract, validate, and propagate `Mcp-Session-Id` correlation header to handlers and outgoing responses | [`src/router/service.rs`](../../src/router/service.rs), [`src/extract/mod.rs`](../../src/extract/mod.rs) |
