...
- **No Deprecated Features**: Do not implement features deprecated as of the MCP `2026-07-28` specification (such as `logging/setLevel` removed via SEP-2577 in favor of per-request `_meta["io.modelcontextprotocol/logLevel"]`). Deprecated features MUST NOT be implemented, retained as deprecated shims, or given backwards compatibility aliases.
